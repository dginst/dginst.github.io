...
- [SEC extends window to decide on ARK 21Shares spot Bitcoin ETF to August - Cointelegraph](https://cointelegraph.com/news/sec-extends-window-to-decide-on-ark-21shares-spot-bitcoin-etf-to-august)

### Regulation - Stablecoins

- [Key objectives of the digital euro - ECB](https://www.ecb.europa.eu/press/blog/date/2022/html/ecb.blog220713~34e21c3240.en.html)
- [The case for a digital euro: key objectives and design considerations - ECB](https://www.ecb.europa.eu//pub/pdf/other/key_objectives_digital_euro~f11592d6fb.en.pdf)
...
- [Uniswap Users Lose Over $8M Worth of Ethereum in Massive Phishing Attack - BeInCrypto](https://beincrypto.com/uniswap-8m-ethereum-massive-phishing-attack/)

### Ecosystem - NFT

- [Deep in Crypto Winter, a CryptoPunks Ethereum NFT Sells for $2.6M - Decrypt](https://decrypt.co/105028/crypto-winter-cryptopunks-ethereum-nft-2-6m)

### Tech

- [Ethereum devs confirm the perpetual date for The Merge - Cointelegraph](https://cointelegraph.com/news/ethereum-dev-confirms-perpetual-date-for-pos-merge)
- [BIP draft: Half-Aggregation of BIP-340 Signatures - bitcoin-dev](https://lists.linuxfoundation.org/pipermail/bitcoin-dev/2022-July/020662.html)
- [Half-aggregation of BIP340 signatures - Blockstream](https://blog.blockstream.com/half-aggregation-of-bip-340-signatures/)
- [Add a `-mempoolfullrbf` node setting by ariard · Pull Request #25353 - GitHub](https://github.com/bitcoin/bitcoin/pull/25353)
